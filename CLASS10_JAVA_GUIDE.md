...
## 📌 2. Everyday Real-World Analogies
...
## 📌 3. Quick Beginner Q&A

### Q1: What does `public static void main(String[] args)` mean?
...
- `System.out.println()`: Prints text and jumps to a **new line** below!

### Q3: Why does `10 / 3` equal `3` instead of `3.333` in Java?
Because both `10` and `3` are integers (`int`). Java cuts off the decimal part!
To get `3.333`, write `10.0 / 3.0`.
